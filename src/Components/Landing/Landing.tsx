...
import AudioSensor from './AudioSensor3d'
  ...
  return (
    <section className='h-screen w-screen bg-codGray overflow-hidden'>
        ...
        <div className='flex mx-10 justify-center'>
            <Image className='absolute bottom-12 pb-11' src='assets/headphones.svg' alt='headphones' loading='eager' height={30} width={30} />
